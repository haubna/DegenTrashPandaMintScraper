...
__IMPORTANT install this and make sure that in the command line the commands "solana" and "curl" work https://docs.solana.com/cli/install-solana-cli-tools __
